...
const Layout: React.FC<LayoutComponentType> = ({ children }) => {
    return (
        <div>
            <nav className="sticky bottom-0 flex w-full flex-wrap items-center justify-between bg-[#FBFBFB] py-3 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 lg:py-4">
